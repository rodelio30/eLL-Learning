    ...
    <div class="main">
      ...
      <main class="content">
        <div class="container-fluid p-0">
          <div class="row">
            <div class="col-md-4">
              <h1 class="h3 mb-3"><strong>Course Outcome</strong> List</h1>
            </div>
            <div class="col-md-4">
            </div>
            <div class="col-md-4">
              <a <?php echo "href=\"admin_course_outcome_add.php\" " ?> style="float: right"
                class="btn btn-success"><span data-feather="user-plus"></span>&nbsp Add New Course Outcome</a>
            </div>
          </div>
          <div class="row">
                      ...
                      while (list($c_outcome_id, $course_id, $number, $description, $date_modified, $status) = mysqli_fetch_array($result)) {
                        ...
                        echo "
														<tr>	
															...
															<td>$status</td>
															<td>
															<a href=\"archive/admin_course_outcome_archive.php?ID=$c_outcome_id\" onClick=\"return confirm('Are you sure you want this course move to archive?')\" class='btn btn-warning btn-md float-end ms-2'><span><img src='img/icons/archive.png' style='width:15px'></span>&nbsp Archive</a>
															</td>
														</tr>	
													";
                      }
