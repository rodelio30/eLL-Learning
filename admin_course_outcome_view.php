...
echo "<script>console.log('Result: " . $c_id . "' );</script>";
                      ...
                      <div class="col-md-12">
                        <div class="card m-4 mt-2">
                          <div class="card-body">
                            ...
                            <div class="row">
                              <div class="col-sm-3">
                                <h6 class="mb-0 flatpickr-weekwrapper"><strong>Number</strong></h6>
                              </div>
                              <div class="col-sm-9 text-secondary">
                                <div class="flatpickr-weekwrapper">
                                  <?php echo $number ?>
                        ...
                        <div class="row">
                          <div class="col-sm-12">
                            <a class="btn btn-info ms-4 mb-2"
                              <?php echo "href=\"admin_course_outcome_edit.php?ID=$c_outcome_id\" " ?>
